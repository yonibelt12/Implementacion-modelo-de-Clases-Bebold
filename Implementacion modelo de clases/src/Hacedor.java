public class Hacedor extends Usuario{
    ...
    public void mostrar(){
        System.out.println("\n\nHacedor ID: "+getUserID()+", Email:"+getEmail()+", Radio Cobertura (km): "+getRadio()+", Telefono:"+getTel()+", Disponibilidad:"+getDisp());
    }
    ...
    public void agregarServicio(String serv){
        perfil.agregarServicio(serv);
    }

    public void eliminarServicio(String serv){
        perfil.eliminarServicio(serv);
    }
